...
export const ARTIST_DETAILS: ArtistDetail[] = [
  {
    ...
    nl: {
      ...
      body: [
        ...
        { k: "h", t: "Tentoonstellingen & geschiedenis" },
        { k: "p", t: "Eerste solotentoonstelling in de Zeepziederij te Bree — de half-industriële ruimte waarin ze haar werk voor het eerst publiek toonde." },
        { k: "p", t: "WHO IS YOUR GOD, WHERE IS SHE — solotentoonstelling bij nodenaysteen / DeNode, Gent. Een zoektocht in zelfportretten naar dualiteit, met vrouwen als dragers van de wereld en toonbeelden van kracht." },
        { k: "p", t: "'Minsterwood' — Kat Bové verschijnt in de centrale triptiek van Wayn Traubs tentoonstelling in de River City Gallery te Bangkok (januari–maart 2026)." },
        { k: "p", t: "Kat Bové solo — Pim De Rudder Stichting, Assenede (3–31 mei 2026). Presentatie van nieuwe werken." },
        { k: "h", t: "Kunstboek" },
    ...
    en: {
      ...
      body: [
        ...
        { k: "h", t: "Exhibitions & history" },
        { k: "p", t: "First solo exhibition at the Zeepziederij in Bree — the semi-industrial space in which she first showed her work publicly." },
        { k: "p", t: "WHO IS YOUR GOD, WHERE IS SHE — solo exhibition at nodenaysteen / DeNode, Ghent. A search in self-portraits for duality, with women as bearers of the world and embodiments of strength." },
        { k: "p", t: "'Minsterwood' — Kat Bové appears in the central triptych of Wayn Traub's exhibition at the River City Gallery in Bangkok (January–March 2026)." },
        { k: "p", t: "Kat Bové solo — Pim De Rudder Foundation, Assenede (3–31 May 2026). A presentation of new works." },
        { k: "h", t: "Art book" },
    ...
    fr: {
      ...
      body: [
        ...
        { k: "h", t: "Expositions & histoire" },
        { k: "p", t: "Première exposition personnelle à la Zeepziederij à Bree — l'espace semi-industriel où elle a montré son travail au public pour la première fois." },
        { k: "p", t: "WHO IS YOUR GOD, WHERE IS SHE — exposition personnelle à nodenaysteen / DeNode, Gand. Une quête, à travers des autoportraits, de la dualité, avec les femmes comme porteuses du monde et incarnations de la force." },
        { k: "p", t: "'Minsterwood' — Kat Bové apparaît dans le triptyque central de l'exposition de Wayn Traub à la River City Gallery de Bangkok (janvier–mars 2026)." },
        { k: "p", t: "Kat Bové solo — Fondation Pim De Rudder, Assenede (3–31 mai 2026). Une présentation de nouvelles œuvres." },
        { k: "h", t: "Livre d'art" },
