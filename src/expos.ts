...
export const EXPOS: Expo[] = [
  ...
  },
  {
    ...
    title: "Vestiges",
    artists: [
      { name: "Chantal Pollier" },
      { name: "Guillaume Van Moerkercke" },
    ],
    curator: "—",
    articleSlugs: ["vestiges"],
  ...
  },
  {
    ...
    title: "(expo)nentieel",
    artists: [{ name: "49 kunstenaars (kettingbrief-netwerk)" }],
  ...
  },
  {
    ...
    artists: [{ name: "Philippe Van De Velde" }],
    curator: "Paul De Cannière",
    tint: "#55603f",
  },
];
