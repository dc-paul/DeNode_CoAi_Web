...
export const EVENT_DETAILS: EventDetail[] = [
  {
    ...
    mailBody: {
      nl: [
        ...
        "",
        "Betaling:",
        "Ik heb de deelnameprijs van € 220 per persoon overgeschreven op [IBAN Stichting DeNode].",
        "",
        "Alvast bedankt!",
        "",
      ...
      en: [
        ...
        "",
        "Payment:",
        "I have transferred the participation fee of € 220 per person to [IBAN Stichting DeNode].",
        "",
        "Thank you!",
        "",
        "Kind regards,",
      ...
      fr: [
        ...
        "",
        "Paiement :",
        "J'ai viré les frais de participation de € 220 par personne sur [IBAN Stichting DeNode].",
        "",
        "Merci !",
        "",
        "Cordialement,",
