...
export interface EventDetail {
  ...
  // Pre-filled email (subject + body) so the visitor only has to fill in the
  // bracketed placeholders. Falls back to a bare mailto when absent.
  mailSubject?: Record<Lang, string>;
  mailBody?: Record<Lang, string>;
...
export const EVENT_DETAILS: EventDetail[] = [
  {
    ...
    mailSubject: {
      nl: "Inschrijving workshop 'Cutting Reality' — DeNode",
      en: "Registration workshop 'Cutting Reality' — DeNode",
      fr: "Inscription atelier « Cutting Reality » — DeNode",
    },
    mailBody: {
      nl: [
        "Beste Sofie en Nicolas,",
        "",
        "Graag schrijf ik me in voor de workshop 'Cutting Reality'.",
        "",
        "Mijn keuze (aankruisen):",
        "- [ ] Workshop 1 — 15, 16 en 17 juli 2026",
        "- [ ] Workshop 2 — 22, 23 en 24 juli 2026",
        "",
        "Mijn gegevens:",
        ...
        "",
        "Betaling:",
        "Ik schrijf de deelnameprijs van € 220 per persoon graag over — mogen jullie mij jullie rekeningnummer doorsturen? (De workshop is een initiatief van Sofie en Nicolas; de betaling gaat rechtstreeks naar hen.)",
        "",
        "Alvast bedankt!",
        "",
      ...
      en: [
        "Dear Sofie and Nicolas,",
        "",
        "I would like to register for the 'Cutting Reality' workshop.",
        "",
        "My choice (tick one):",
        "- [ ] Workshop 1 — 15, 16 and 17 July 2026",
        "- [ ] Workshop 2 — 22, 23 and 24 July 2026",
        "",
        "My details:",
        ...
        "",
        "Payment:",
        "I will gladly transfer the participation fee of € 220 per person — could you send me your account number? (The workshop is Sofie and Nicolas's initiative; payment goes directly to them.)",
        "",
        "Thank you!",
        "",
        "Kind regards,",
      ...
      fr: [
        "Bonjour Sofie et Nicolas,",
        "",
        "Je souhaite m'inscrire à l'atelier « Cutting Reality ».",
        "",
        "Mon choix (cocher) :",
        "- [ ] Atelier 1 — 15, 16 et 17 juillet 2026",
        "- [ ] Atelier 2 — 22, 23 et 24 juillet 2026",
        "",
        "Mes coordonnées :",
        "- Nom : [prénom et nom]",
        "- E-mail : [votre e-mail]",
        ...
        "",
        "Paiement :",
        "Je virerai volontiers les frais de participation de € 220 par personne — pourriez-vous m'envoyer votre numéro de compte ? (L'atelier est une initiative de Sofie et Nicolas ; le paiement leur revient directement.)",
        "",
        "Merci !",
        "",
        "Cordialement,",
  ...
  },
  {
    ...
    mailSubject: {
      nl: "Deelname tekensessies op model — DeNode",
      en: "Joining the life drawing sessions — DeNode",
      fr: "Participation aux séances de dessin d'après modèle — DeNode",
    },
    mailBody: {
      nl: [
        "Beste DeNode-team,",
        "",
        "Graag neem ik deel aan de tekensessies op model (hervatting vanaf oktober 2026).",
        "",
        "Mijn gegevens:",
        "- Naam: [voornaam en naam]",
        "- E-mail: [je e-mailadres]",
      ...
      en: [
        "Dear DeNode team,",
        "",
        "I would like to join the life drawing sessions (resuming from October 2026).",
        "",
        "My details:",
        "- Name: [first name and surname]",
        "- Email: [your email]",
      ...
      fr: [
        ...
        "",
        "Je souhaite participer aux séances de dessin d'après modèle (reprise à partir d'octobre 2026).",
        "",
        "Mes coordonnées :",
        "- Nom : [prénom et nom]",
        "- E-mail : [votre e-mail]",
        "- Téléphone : [votre numéro de téléphone]",
        "",
        "Question ou remarque : [facultatif]",
        "",
        "Merci !",
        "",
        "Cordialement,",
